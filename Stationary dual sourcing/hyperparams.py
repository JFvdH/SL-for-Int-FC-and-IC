...
def evalHypers (genFunc, evalFunc, params, hypers) :
    ...
    # Train the model
    model_exp, model_reg = train(genFunc, params, hypers)

    # Evaluate the model
    costs = evalFunc(model_exp, model_reg, params)
...
class Objective(object):
    ...
    def __call__(self, trial):
        ...
        hyperparams = {}
        hyperparams['inv_multiplier_1'] = trial.suggest_int('inv_multiplier_1', 2, 32, log=True)
        ...
        hyperparams['learning_rate_1'] = trial.suggest_float('learning_rate_1', 0.0004, 0.08, log=True)
        ...
        hyperparams['learning_rate_2'] = trial.suggest_float('learning_rate_2', 0.0004, 0.08, log=True)
        ...
        if self.params['verbose'] == True :
            ...
            print("Inv. multiplier: \t", hyperparams["inv_multiplier_2"])   
            print("Nr. of estimators: \t", hyperparams["n_estimators_2"])   
            print("Nr. of leaves: \t\t", hyperparams["num_leaves_2"])
            print("Learning rate: \t\t", round(hyperparams["learning_rate_2"],4)) 
...
# Function definition
# Takes set of experiments, a generation function and an evaluation function as input
